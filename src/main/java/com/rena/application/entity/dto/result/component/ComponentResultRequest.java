package com.rena.application.entity.dto.result.component;
 ...
 */
@Getter
public class ComponentResultRequest extends RpcBase {
    ...
    public ComponentResultRequest(String name, String value, String serialNumber, String stationName, String code) {
        super();
        this.name = name;
        this.value = value;
