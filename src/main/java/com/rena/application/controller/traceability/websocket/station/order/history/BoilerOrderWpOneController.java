...
public class BoilerOrderWpOneController {
    ...
    public void addBoilerOrder(@Payload CanbanUniqueCode canbanUniqueCode) {
        try {
            var boilerOrder = boilerOrderManageService.addOrder(canbanUniqueCode);
    ...
    public void updateBoilerOrder(@Payload Canban canban) {
        try {
            var boilerOrder = boilerOrderManageService.updateOrder(canban);
    ...
    public void getAmountPrinterBoilerOrder() {
        try {
            //var amountPrintedBarcode = boilerOrderManageService.getAmountPrintedBarcode();
    ...
    public void updateAmountPrinterBoilerOrder(Integer amountPrintedBarcode) {
        try {
            //var amountPrintedBarcodeUpd = boilerOrderManageService.updateAmountPrintedBarcode(amountPrintedBarcode);
