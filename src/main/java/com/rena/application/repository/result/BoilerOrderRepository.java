...
public interface BoilerOrderRepository extends JpaRepository<BoilerOrder, String> {
    ...
    @Query("select b from BoilerOrder b JOIN FETCH b.userHistory JOIN FETCH b.boilerTypeCycle where b.id = ?1")
    Optional<BoilerOrder> findBoilerOrderByById(String s);
}