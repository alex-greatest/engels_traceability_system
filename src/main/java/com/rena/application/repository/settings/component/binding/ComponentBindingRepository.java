package com.rena.application.repository.settings.component.binding;

import com.rena.application.entity.model.settings.component.ComponentType;
import com.rena.application.entity.model.settings.component.binding.ComponentBinding;
