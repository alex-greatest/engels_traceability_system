...
public class CheckerReworkStationService {
    ...
    public void checkStationRework(String stationName, String serialNumber) {
        ...
        switch (typeStation) {
            ...
            case "Материалы" -> reworkComponentsStationService.startReworkMaterialStation(serialNumber);
            default -> {
            }
        }
    }
    ...
    public RpcBase startOperation(Boiler boiler, StationHistory station) {
        ...
        return switch (typeStation) {
            ...
            case "Материалы" -> materialsPrepareOperationService.createResponseOperationMaterials(boiler, station);
