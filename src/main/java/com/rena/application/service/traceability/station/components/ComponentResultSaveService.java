...
import com.rena.application.entity.dto.result.component.ComponentResultResponse;
...
public class ComponentResultSaveService {
    ...
    private ComponentResultResponse saveComponentValue(ComponentResultRequest componentResultRequest) {
        ...
        var componentTypeOptional = componentTypeRepository.findByCode(codeComponent);
